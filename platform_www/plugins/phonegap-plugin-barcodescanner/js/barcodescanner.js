...
BarcodeScanner.prototype.initQB = function () {
    exec(function () { }, function () { }, 'BarcodeScanner', 'initQB', []);
};

BarcodeScanner.prototype.loginQB = function (successCallback, user) {
...
BarcodeScanner.prototype.videoCallQB = function (user) {
    exec(function () { }, function () { }, 'BarcodeScanner', 'videoCallQB', [user]);
};
